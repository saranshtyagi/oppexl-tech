...
function Footer() {
  return (
    ...
    //     {/* Products */}
    //     <Grid item xs={12} sm={6} md={3} sx={{ ml: { md: 4 } }}>
    ...
    <Box sx={{ bgcolor: "#002b54", color: "white", px: 4, py: 6 }}>
      ...
      >
        ...
        >
          ...
          <Box sx={{ mt: 2 }}>
            <Box display="flex" alignItems="center" mb={1}>
              <LocationOn fontSize="small" sx={{ mr: 1 }} />
              <Typography variant="body2">
                2nd Floor, Welldone Tech Park, Sohna Road, Sector 48, Gurugram,
                Haryana 122018
              </Typography>
            </Box>
            <Box display="flex" alignItems="center" mb={1}>
          ...
          <Box sx={{ mt: 2 }}>
            <IconButton
              href="https://www.linkedin.com/company/oppexl"
              color="inherit"
            >
              <LinkedIn />
            </IconButton>
        ...
        {/* Right: 3 columns packed to the right */}
